CREATE OR REPLACE FORCE VIEW "V_WYC2"
         ("NR_KOM_ZLEC", "NR_ZLEC", "NR_POZ_ZLEC", "ID_POZ", "SORT", "IDENT_BUD",
          ...
          "WSP_P", "WSP_W", "WSP_4ZAKR", "CIAG_NR_INST", "CIAG_PROD",
 ...
 SELECT /*+ use_nl (L S S0 W1 W2)*/ 
  ...
  nvl(max(W0.wsp_alt),0) wsp_p0,
  --rank() over (partition by L.nr_kom_zlec,L.nr_poz_zlec,L.nr_szt,L.nr_warst,L.nr_inst_plan order by L.kolejn) ktora_obr_na_inst,
